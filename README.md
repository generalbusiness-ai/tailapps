...
See a vertically truncated [sample result](docs/assets/visual-report-sample.png) (headlines and arrival timeline; 1280 × 700 PNG): <a href="docs/assets/visual-report-sample.png"><img src="docs/assets/visual-report-sample.png" alt="Vertically truncated visual-report sample" width="320"></a>
