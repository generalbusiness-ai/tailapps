...
preserved: the goldens were generated by the pre-extraction implementation
and the stage-4 differential runs proved the core byte-identical over them;
since stage 6 the core is the only implementation and this corpus is the
standing freeze it must keep matching.
